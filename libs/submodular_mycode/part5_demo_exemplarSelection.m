...
K = 18;  % select K desired receptive fields
...
tic
RFpositive1 = DiscriminativeExemplarSelection_standardGreedy(SimilarityGraph, SimilarityGraph_full, SimilarityGraph_full, imgIdx, K, lambdaL, lambdaD, lambdaE, lambdaB);
toc
