...
locationScaleFactor = 0.006;

T = 35; % nonzero elements default 40
T = 300
lambda = 0.0; % weight of location-aware penalty default 0.09

%{
81.7518%(T=30), 83.0657%(T=35), 81.7518%(T=37), 0.8248(T=40)
------- T=35 --> lambda
83.0657%(lambda=0), 76.7883%(0.01), 71.8248% (lambda=1), 70.365%(lambda=3)
------- T=35 lambda=0 --> locationScaleFactor
77.3723% (0.001), 83.0657%(0.004),82.7737%(0.005), 83.2117%(0.006),
82.9197%(0.008), 82.9197%(0.01), 82.9197%(0.02), 

------- T=35 locationScaleFactor=0.006--> lambda
82.6277%(0.00001) 81.6058%(0.0001), 76.7883%(0.001), 68.0292%(1)
...
model = libsvm_svmtrain(trainClassLabel', scXTrain', '-s 0 -c 5 -t 0'); % linear 
