...
databaseSourceDir = './mixedSamples_binaryMask_canonicalShape_globalContrastNorm';
databaseDestinationDir = './mixedSamples_binaryMask_CNNfeature_globalContrastNorm';

% databaseSourceDir = './mixedSamples_binaryMask_canonicalShape';
% databaseDestinationDir = './mixedSamples_binaryMask_CNNfeature';

% databaseSourceDir = './mixedSamples_thumbnail_canonicalShape';
% databaseDestinationDir = './mixedSamples_thumbnail_CNNfeature';
...
categoryList = dir( strcat(databaseSourceDir, '/mix*'));
