...
locationScaleFactor = 0.002;

T = 45; % nonzero elements default 40
lambdaLoc = 0.1; % weight of location-aware penalty default 0.09
lambda1 = 0.01; % weight for sparsity

%{
---> lambdaLoc
83.5036%(0.05), 84.0876%(0.1), 83.9416%(0.2), 84.0876%(0.5), 82.6277%(1)

----lambdaLoc=0.1 ---> lambda1
82.9197%(0.001), 83.6496%(0.002), 83.7956%(0.005),83.7956%(0.008), 84.0876%(0.01),
84.0876%(0.012), 82.7737%(0.02)

----lambdaLoc=0.1 lambda1=0.01 ---> locationScaleFactor
84.0876%(0.001), 85.4015%(0.0015), 85.6934%(0.002), 85.5474%(0.0025),
85.1095%(0.003), 83.3577%(0.004)
%}
...
model = libsvm_svmtrain(trainClassLabel', scXTrain', '-s 0 -c 30 -t 0'); % linear 
