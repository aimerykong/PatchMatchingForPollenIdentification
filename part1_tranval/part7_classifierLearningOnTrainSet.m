...
fprintf('accuracy=%.4f (lambda=%.4f, T=%d)\n', acc, lambda, T);
for categID = 1:numel(pollenName)
...
%% save results
save( ['./result3/valscFeatOnExemplar_layer' num2str(curLayer) '_' shapeType '_T' num2str(T) '_lambda' num2str(lambda) '_ResultACC' num2str(bestAcc) '_globalContrastNorm.mat'], ...
    'bestAcc', 'alphaIdx',...       
