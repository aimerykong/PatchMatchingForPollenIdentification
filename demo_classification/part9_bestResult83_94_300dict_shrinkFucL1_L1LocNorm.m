...
model = libsvm_svmtrain(trainClassLabel', scXTrain', '-s 0 -c 20 -t 0'); % linear 
...
%% save results
save( ['./valscFeatOnExemplar_layer' num2str(curLayer) '_' shapeType '_T' num2str(T) '_lambda1' num2str(lambda1) '_ResultACC' num2str(bestAcc) '_globalContrastNorm.mat'], ...
    'bestAcc', 'alphaIdx',...       
