...
smallK = 600; % extract first smallK atoms as the dictionary rather than the whole
lambdaL = 0.01;
...
locationScaleFactor = 0.003;

T = 37; % nonzero elements default 40
lambda = 4; % weight of location-aware penalty default 0.09

%{
---------> T
78.8321%(T=25), 81.1679%(T=30), 81.8978%(T=27), 81.8978%(T=35),
81.8978%(T=40), 80.292%(T=45), 
------- T=37 --> lambda
81.0219% (lambda=3), 81.8978% (lambda=4), 81.1679% (lambda=5)
------- T=37, lambda=4 --> locationScaleFactor
75.4745%(0.001), 81.1679%(0.002), 82.6277%(0.003), 81.8978%(0.004),
82.3358%(0.005), 81.0219%(0.006), 
%}
